...
/**
 * <p>Clase Java para getNumberValueByatCalogAndVariable complex type.
 *
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera
 * que haya en esta clase.
 *
 * <pre>
 * &lt;complexType name="getNumberValueByatCalogAndVariable">
 *   &lt;complexContent>
...
@XmlType(name = "getNumberValueByatCalogAndVariable", propOrder = {
    "catalogo",
    "variable"
})
public class GetNumberValueByatCalogAndVariable {
