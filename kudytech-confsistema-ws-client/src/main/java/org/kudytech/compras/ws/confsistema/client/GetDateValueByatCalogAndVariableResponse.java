...
/**
 * <p>Clase Java para getDateValueByatCalogAndVariableResponse complex type.
 *
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera
 * que haya en esta clase.
 *
 * <pre>
 * &lt;complexType name="getDateValueByatCalogAndVariableResponse">
 *   &lt;complexContent>
...
@XmlType(name = "getDateValueByatCalogAndVariableResponse", propOrder = {
    "_return"
})
public class GetDateValueByatCalogAndVariableResponse {
