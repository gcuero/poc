...
/**
 * <p>Clase Java para getBlobValueByatCalogAndVariableResponse complex type.
 *
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera
 * que haya en esta clase.
 *
 * <pre>
 * &lt;complexType name="getBlobValueByatCalogAndVariableResponse">
 *   &lt;complexContent>
...
@XmlType(name = "getBlobValueByatCalogAndVariableResponse", propOrder = {
    "_return"
})
public class GetBlobValueByatCalogAndVariableResponse {
