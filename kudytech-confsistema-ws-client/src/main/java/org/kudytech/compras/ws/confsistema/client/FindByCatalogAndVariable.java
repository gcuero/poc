...
/**
 * <p>Clase Java para findByCatalogAndVariable complex type.
 *
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera
 * que haya en esta clase.
 *
 * <pre>
 * &lt;complexType name="findByCatalogAndVariable">
 *   &lt;complexContent>
...
@XmlType(name = "findByCatalogAndVariable", propOrder = {
    "catalogo",
    "variable"
})
public class FindByCatalogAndVariable {
