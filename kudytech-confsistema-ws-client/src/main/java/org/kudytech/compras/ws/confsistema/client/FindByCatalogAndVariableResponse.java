...
/**
 * <p>Clase Java para findByCatalogAndVariableResponse complex type.
 *
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera
 * que haya en esta clase.
 *
 * <pre>
 * &lt;complexType name="findByCatalogAndVariableResponse">
 *   &lt;complexContent>
...
@XmlType(name = "findByCatalogAndVariableResponse", propOrder = {
    "_return"
})
public class FindByCatalogAndVariableResponse {
