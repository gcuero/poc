...
/**
 * <p>Clase Java para getBlobValueByatCalogAndVariable complex type.
 *
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera
 * que haya en esta clase.
 *
 * <pre>
 * &lt;complexType name="getBlobValueByatCalogAndVariable">
 *   &lt;complexContent>
...
@XmlType(name = "getBlobValueByatCalogAndVariable", propOrder = {
    "catalogo",
    "variable"
})
public class GetBlobValueByatCalogAndVariable {
