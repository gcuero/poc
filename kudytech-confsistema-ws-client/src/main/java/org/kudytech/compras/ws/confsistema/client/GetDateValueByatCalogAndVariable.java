...
/**
 * <p>Clase Java para getDateValueByatCalogAndVariable complex type.
 *
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera
 * que haya en esta clase.
 *
 * <pre>
 * &lt;complexType name="getDateValueByatCalogAndVariable">
 *   &lt;complexContent>
...
@XmlType(name = "getDateValueByatCalogAndVariable", propOrder = {
    "catalogo",
    "variable"
})
public class GetDateValueByatCalogAndVariable {
