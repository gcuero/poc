...
/**
 * <p>Clase Java para getStringValueByCatalogAndVariableResponse complex type.
 *
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera
 * que haya en esta clase.
 *
 * <pre>
 * &lt;complexType name="getStringValueByCatalogAndVariableResponse">
 *   &lt;complexContent>
...
@XmlType(name = "getStringValueByCatalogAndVariableResponse", propOrder = {
    "_return"
})
public class GetStringValueByCatalogAndVariableResponse {
