...
/**
 * <p>Clase Java para getListStateByNameResponse complex type.
 *
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera
 * que haya en esta clase.
 *
 * <pre>
 * &lt;complexType name="getListStateByNameResponse">
 *   &lt;complexContent>
...
@XmlType(name = "getListStateByNameResponse", propOrder = {
    "_return"
})
public class GetListStateByNameResponse {
