...
/**
 * <p>Clase Java para canTranscendObjectByLoginResponse complex type.
 *
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera
 * que haya en esta clase.
 *
 * <pre>
 * &lt;complexType name="canTranscendObjectByLoginResponse">
 *   &lt;complexContent>
...
@XmlType(name = "canTranscendObjectByLoginResponse", propOrder = {
    "_return"
})
public class CanTranscendObjectByLoginResponse {
