...
/**
 * <p>Clase Java para getWorkflowNextStateResponse complex type.
 *
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera
 * que haya en esta clase.
 *
 * <pre>
 * &lt;complexType name="getWorkflowNextStateResponse">
 *   &lt;complexContent>
...
@XmlType(name = "getWorkflowNextStateResponse", propOrder = {
    "_return"
})
public class GetWorkflowNextStateResponse {
