...
/**
 * <p>Clase Java para transcendObjectByLoginResponse complex type.
 *
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera
 * que haya en esta clase.
 *
 * <pre>
 * &lt;complexType name="transcendObjectByLoginResponse">
 *   &lt;complexContent>
...
@XmlType(name = "transcendObjectByLoginResponse", propOrder = {
    "_return"
})
public class TranscendObjectByLoginResponse {
