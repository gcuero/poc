...
/**
 * <p>Clase Java para getIdConfObjetoByClassNameResponse complex type.
 *
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera
 * que haya en esta clase.
 *
 * <pre>
 * &lt;complexType name="getIdConfObjetoByClassNameResponse">
 *   &lt;complexContent>
...
@XmlType(name = "getIdConfObjetoByClassNameResponse", propOrder = {
    "_return"
})
public class GetIdConfObjetoByClassNameResponse {
